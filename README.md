...
- [**obsidian-share-hosted**](https://github.com/yut0takagi/obsidian-share-hosted) — マジックリンク認証でノートを共有、Cloudflare設定不要
- [**obsidian-org-share**](https://github.com/yut0takagi/obsidian-org-share) — CF Accessでゲートした非公開URLでノートを共有 (組織ドメイン/許可リスト/公開)
- [**obsidian-spread-sync**](https://github.com/yut0takagi/obsidian-spread-sync) — Google Sheetsのセル/範囲をノートに埋め込み、開いた時に同期・書き戻し
...
- [**claude-code-plugin-demo**](https://github.com/yut0takagi/claude-code-plugin-demo) — 日本語Claude Code向けSkillsコレクション (人間味・深掘り・リサーチ・議事録 等7種)
- [**flux-tyo**](https://github.com/yut0takagi/flux-tyo) — Claudeが自律トレーダーになれるか試すサイバーパンク・ペーパートレーディング
